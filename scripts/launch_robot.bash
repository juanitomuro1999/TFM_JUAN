...
case "$STEP" in
  ...
  camera)
    ...
    ;;
  follower)
    echo "[5/5] Lanzando sistema person_follower..."
  ...
  status)
    ...
    ;;
  *)
    echo "Uso: $0 {kobuki|lidar|tf|camera|follower|status}"
    echo ""
    ...
    echo "  Terminal 5: $0 follower"
    echo "  Terminal 6: $0 status"
    ;;
esac
