...
5. **Guiado de usuarios:** implementar comportamientos de acompañamiento hacia destinos predefinidos del edificio. *(**Primer paso completado y validado en el robot real el 2026-09-23:** gesto "casa". Con un gesto ("tejado", ambas manos juntas sobre la cabeza), el usuario ordena al robot que deje de seguirle y vuelva de forma autónoma con Nav2 a una pose predefinida. Es la primera integración de seguimiento y navegación en un único sistema, con `control_node` como árbitro de la velocidad. Resultado: 9 vueltas completadas de 11 pedidas (15.5 s y 0.27 m de media), cancelación con otro gesto, 0 falsos positivos. Los 2 fallos se deben a la localización junto a obstáculos. El guiado a varios destinos queda como trabajo futuro sobre la misma arquitectura. Ver `docs/07_resultados.md` §7.4quinquies y `docs/decisiones.md` 2026-09-23.)*
